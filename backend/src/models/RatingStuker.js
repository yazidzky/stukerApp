...
const RatingStukerSchema = new mongoose.Schema(
  {
    orderId: {
...
RatingStukerSchema.index({ orderId: 1, raterId: 1 }, { unique: true });

module.exports = mongoose.model("RatingStuker", RatingStukerSchema);
